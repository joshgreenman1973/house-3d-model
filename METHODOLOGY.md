...
- **Room names** follow the listing plans, with one correction: the listing labeled three rooms in the suite wing "Primary Bedroom." The 30'0" × 27'8" room is the bedroom; the 12'11" × 13'0" and 9'6" × 10'2" rooms beside it are walk-in closets (the owner's identification) and the 2D planner labels them as closets. The 3D model still shows the listing's names.
